...
if state.get("eventsSet") is not None:
    new_events = state["eventsSet"]
    if isinstance(new_events, list):
        st.session_state["events"] = new_events  # replace, not append
    elif isinstance(new_events, dict) and "events" in new_events:
        st.session_state["events"] = new_events["events"]
